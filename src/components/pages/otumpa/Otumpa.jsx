        ...
        >
          <Box textAlign={"center"}>
            <img
              ...
              width={"70%"}
              src="imagenes/otumpa/otumpa1.png"
              alt=""
            />
          </Box>
          ...
          <Box textAlign={"center"}>
            <img
              ...
              width={"100%"}
              src="imagenes/otumpa/otumpa2.png"
              alt=""
            />
          </Box>
          ...
          <Box textAlign={"center"}>
            <img
              style={{ marginTop: "180px" }}
              width={"70%"}
              src="imagenes/otumpa/otumpa3.png"
              alt=""
            />
          </Box>
          ...
          <Box textAlign={"center"}>
            <img
              style={{ marginTop: "180px" }}
              width={"100%"}
              src="imagenes/otumpa/otumpa4.png"
              alt=""
            />
          </Box>
          ...
          <Box mb={"290px"} textAlign={"center"}>
            <img
              style={{ marginTop: "180px" }}
              width={"100%"}
              src="imagenes/otumpa/otumpa5.png"
              alt=""
            />
          </Box>
        </Box>
