...
export default function ElTaco() {
  return (
    <>
<Box mt={20}  mb={5}>
  <Typography sx={{textAlign:"center", fontSize:"31px", fontWeight:"600",lineHeight:"normal", fontFamily: 'Albert Sans', }} variant="h4"> METEORIT, "EL TACO"</Typography>
...
<Box sx={{display: "flex", justifyContent:"center", mt:12  }}>
   <Typography sx={{fontSize:"15px", fontWeight:"500",lineHeight:"23px", fontFamily: 'Albert Sans', width:388}}>
