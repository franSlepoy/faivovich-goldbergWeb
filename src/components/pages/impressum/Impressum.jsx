...
const Impressum = () => {
  ...
  return (
    ...
    <Hidden smDown>
      ...
      <Typography sx={{ fontSize:"19px" ,fontWeight:"600", lineHeight:"19px", fontFamily:"Albert Sans",}} variant='h3'>Faivovich & Goldberg </Typography>
      ...
      <Typography sx={{ mt:5, width:"444px",fontSize:"15px", fontWeight:"500", lineHeight:"19px", fontFamily:"Albert Sans",textIndent:42}} variant="subtitle2"> 
    ...
    <Box sx={{marginLeft:8}} width={"267px"}   >
      <Typography sx={{mt: 20,mb:8, fontSize:"19px",fontWeight:"600",lineHeight:"normal", fontFamily:"Albert Sans",}} variant='h3'>CONTACT</Typography>
    <Box mb={2}>
    <a
...
>
    Barro Galería
      ...
      <Typography sx={{fontSize:"15px", fontWeight:"500", lineHeight:"19px", fontFamily:"Albert Sans",}} variant='h5'>BUENOS AIRES, ARG +54 1149783759</Typography>
     </Box>
     ...
     <Typography sx={{mt:8,ml:8,fontSize:"19px",fontWeight:"600",lineHeight:"normal", fontFamily:"Albert Sans"}}>CV</Typography>
     </Box>
