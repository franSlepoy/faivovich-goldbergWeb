...
const Biography = () => {
  ...
  return (
    <Box margin={"auto"} width={460}>
      ...
      <Typography sx={{ fontSize:17, fontFamily:"Albert Sans",}} variant="subtitle2">(Buenos Aires, 1977 / Paris, 1978) </Typography>
      <Typography sx={{ mt:5, fontSize:17, fontFamily:"Albert Sans",textIndent:42}} variant="subtitle2"> 
      ...
      <Typography sx={{with:400, mb:5, ml:5, fontSize:17, fontFamily:"Albert Sans", textIndent:42}} variant="subtitle2"> 
     ...
     <Box component={NavLink} to={"/index"} style={linkStyle}>
     <Typography sx={{fontSize:17, fontFamily:"Albert Sans", mb:5, mt:8}}>Curriculum Vitae</Typography>
     </Box>
