...
<Box>
<Typography sx={{fontSize:"15px", fontWeight:"500",lineHeight:"23px", fontFamily: 'Albert Sans', width:388}}>Who owns the sky? Or for that matter, anything that falls from the sky? Certain 
